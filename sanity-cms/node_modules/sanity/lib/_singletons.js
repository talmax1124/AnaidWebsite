...
var _createContext = require("sanity/_createContext"), rxjs = require("rxjs"), jsxRuntime = require("react/jsx-runtime"), reactCompilerRuntime = require("react-compiler-runtime");
const ActiveWorkspaceMatcherContext = _createContext.createContext("sanity/_singletons/context/active-workspace-matcher", null), AddonDatasetContext = _createContext.createContext("sanity/_singletons/context/addon-dataset", null), AppIdCacheContext = _createContext.createContext("sanity/_singletons/context/app-id-cache", null), AssetLimitUpsellContext = _createContext.createContext("sanity/_singletons/context/asset-limit-upsell", null), CalendarContext = _createContext.createContext("sanity/_singletons/context/calendar", void 0), ChangeIndicatorTrackerContextStore = _createContext.createContext("sanity/_singletons/context/change-indicator-tracker-store", null), ChangeIndicatorTrackerContextGetSnapshot = _createContext.createContext("sanity/_singletons/context/change-indicator-tracker-get-snapshot", null), ColorSchemeSetValueContext = _createContext.createContext("sanity/_singletons/context/color-scheme-set-value", null), ColorSchemeValueContext = _createContext.createContext("sanity/_singletons/context/color-scheme-value", null), CommentInputContext = _createContext.createContext("sanity/_singletons/context/comment-input", null), CommentsAuthoringPathContext = _createContext.createContext("sanity/_singletons/context/comments-authoring-path", null), CommentsContext = _createContext.createContext("sanity/_singletons/context/comments", null), CommentsEnabledContext = _createContext.createContext("sanity/_singletons/context/comments-enabled", {
  ...
  path: []
}), DocumentActionPropsContext = _createContext.createContext("sanity/_singletons/context/document-action-props", void 0), DocumentActionsStateContext = _createContext.createContext("sanity/_singletons/context/actions-state", null), DocumentChangeContext = _createContext.createContext("sanity/_singletons/context/document-change", null), DocumentFieldActionsContext = _createContext.createContext("sanity/_singletons/context/document-field-actions", null), DocumentIdContext = _createContext.createContext("sanity/_singletons/context/document-id", null), DocumentLimitUpsellContext = _createContext.createContext("sanity/_singletons/context/document-limit-upsell", null), DocumentPaneContext = _createContext.createContext("sanity/_singletons/context/document-pane", null), DocumentSheetListContext = _createContext.createContext("sanity/_singletons/context/document-sheet-list", void 0), EnhancedObjectDialogContext = _createContext.createContext("sanity/_singletons/context/enhanced-object-dialog-enabled", {
  enabled: !1,
  isDialogAvailable: !1,
  legacyEditing: !1
...
const PaneRouterContext = _createContext.createContext("sanity/_singletons/context/pane-router", {
  ...
  selected: !1
}), ReferenceInputOptionsContext = _createContext.createContext("sanity/_singletons/context/reference-input-options", {}), ReferenceItemRefContext = _createContext.createContext("sanity/_singletons/context/reference-item-ref", null), ReleasesMetadataContext = _createContext.createContext("sanity/_singletons/context/releases-metadata", null), TableContext = _createContext.createContext("sanity/_singletons/context/releases-table", null), ReleasesUpsellContext = _createContext.createContext("sanity/_singletons/context/releases-upsell", null), ResolvedPanesContext = _createContext.createContext("sanity/_singletons/context/resolved-panes", null);
function ResolvedPanesProvider(t0) {
  ...
  let t1;
  return $[0] !== children || $[1] !== value ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(ResolvedPanesContext.Provider, { value, children }), $[0] = children, $[1] = value, $[2] = t1) : t1 = $[2], t1;
}
const ResourceCacheContext = _createContext.createContext("sanity/_singletons/context/resource-cache", null), ReviewChangesContext = _createContext.createContext("sanity/_singletons/context/review-changes", {
  onOpenReviewChanges: () => {
  },
  onSetFocus: () => {
  },
...
exports.DocumentActionsStateContext = DocumentActionsStateContext;
...
exports.ResolvedPanesContext = ResolvedPanesContext;
exports.ResolvedPanesProvider = ResolvedPanesProvider;
