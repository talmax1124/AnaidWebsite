...
function RouterProvider(props) {
  ...
  $[0] !== routerProp || $[1] !== state._searchParams ? (t0 = (intentName, parameters, _searchParams) => {
    ...
    return routerProp.encode({
      ...
      _searchParams: toPairs__default.default({
        ...fromPairs__default.default((state._searchParams ?? []).filter(_temp)),
  ...
  bb0: {
    ...
    let t62;
    $[20] !== _searchParams_0 ? (t62 = partition__default.default(_searchParams_0, _temp3), $[20] = _searchParams_0, $[21] = t62) : t62 = $[21];
  ...
  const router = t7;
  let t8;
  return $[41] !== props.children || $[42] !== router ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.RouterContext.Provider, { value: router, children: props.children }), $[41] = props.children, $[42] = router, $[43] = t8) : t8 = $[43], t8;
}
function _temp3(t0) {
  const [key_1] = t0;
...
const RouteScope = function(props) {
  ...
  let t6;
  return $[21] !== childRouter || $[22] !== children ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.RouterContext.Provider, { value: childRouter, children }), $[21] = childRouter, $[22] = children, $[23] = t6) : t6 = $[23], t6;
};
