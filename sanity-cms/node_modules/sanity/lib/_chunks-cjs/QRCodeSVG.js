"use strict";
var jsxRuntime = require("react/jsx-runtime"), reactCompilerRuntime = require("react-compiler-runtime"), react = require("motion/react"), React = require("react");
/**
...
function QRCodeSVGComponent(props) {
  ...
  let t12;
  $[18] !== color || $[19] !== fgPath ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(react.motion.path, { fill: color, d: fgPath, shapeRendering: "crispEdges", initial: t9, animate: t10, exit: t11 }), $[18] = color, $[19] = fgPath, $[20] = t12) : t12 = $[20];
  let t13;
