...
async function buildSanityApp(args, context, overrides) {
  const timer = timing.getTimer(), {
    ...
    cliConfig,
    output
  }), installedSdkVersion = await timing.readModuleVersion(context.workDir, "@sanity/sdk-react"), installedSanityVersion = await timing.readModuleVersion(context.workDir, "sanity");
