...
function useResolvedPanes() {
  const $ = reactCompilerRuntime.c(15), [error, setError] = React.useState(), [maximizedPane, setMaximizedPane] = React.useState(null);
  if (error)
    throw error;
  const {
    structureContext,
  ...
  }, t2 = [rootPaneNode, routerPanesStream, structureContext], $[1] = rootPaneNode, $[2] = routerPanesStream, $[3] = structureContext, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), React.useEffect(t1, t2);
  let t3;
...
`, isSaveHotkey = isHotkeyEsm.isHotkey("mod+s"), StructureTool = React.memo(function(t0) {
  const $ = reactCompilerRuntime.c(48), {
    ...
    layoutCollapsed,
    setLayoutCollapsed
  } = structure.useStructureTool(), resolvedPanesValue = useResolvedPanes(), {
    paneDataItems,
    resolvedPanes,
    setMaximizedPane,
    maximizedPane
  } = resolvedPanesValue, isResolvingIntent = router.useRouterState(_temp$1), {
    sanity: t1
  } = ui.useTheme(), {
    media
  ...
  }, t6 = [onPaneChange, resolvedPanes], $[6] = onPaneChange, $[7] = resolvedPanes, $[8] = t5, $[9] = t6) : (t5 = $[8], t6 = $[9]), React.useEffect(t5, t6);
  let t7, t8;
  $[10] !== pushToast ? (t7 = () => {
  ...
  }, t8 = [pushToast], $[10] = pushToast, $[11] = t7, $[12] = t8) : (t7 = $[11], t8 = $[12]), React.useEffect(t7, t8);
  const hasDefinedDocumentTypes = schema._original?.types.some(sanity._isCustomDocumentTypeDefinition);
  let t9;
  $[13] !== navigate || $[14] !== routerState?.panes || $[15] !== setMaximizedPane ? (t9 = (paneData) => {
    ...
    if (paneData.pane !== structure.LOADING_PANE && paneData.pane.type === "document") {
  ...
  const onSetMaximizedPane = t9, previousSelectedIndexRef = React.useRef(-1);
  let t10, t11;
  if ($[17] !== maximizedPane || $[18] !== paneDataItems || $[19] !== setMaximizedPane ? (t10 = () => {
    ...
    if (previousSelectedIndexRef.current = selectedIndex, !!maximizedPane) {
      if (maximizedPane.pane !== structure.LOADING_PANE && maximizedPane.pane.type !== "document") {
      ...
      if (!paneDataItems.some((pane_2) => pane_2.key === maximizedPane.key)) {
        const fallbackPane = paneDataItems.find((pane_3) => pane_3.groupIndex === maximizedPane.groupIndex && pane_3.siblingIndex === maximizedPane.siblingIndex && pane_3.pane !== structure.LOADING_PANE && pane_3.pane.type === "document");
        setMaximizedPane(fallbackPane || null);
      }
    }
  }, t11 = [maximizedPane, paneDataItems, setMaximizedPane], $[17] = maximizedPane, $[18] = paneDataItems, $[19] = setMaximizedPane, $[20] = t10, $[21] = t11) : (t10 = $[20], t11 = $[21]), React.useEffect(t10, t11), !hasDefinedDocumentTypes) {
    let t122;
    return $[22] === Symbol.for("react.memo_cache_sentinel") ? (t122 = /* @__PURE__ */ jsxRuntime.jsx(NoDocumentTypesScreen, {}), $[22] = t122) : t122 = $[22], t122;
  }
  ...
  if ($[23] !== onSetMaximizedPane || $[24] !== paneItemsToShow) {
    ...
    $[26] !== onSetMaximizedPane ? (t162 = (paneData_0) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: pane_4 === structure.LOADING_PANE ? /* @__PURE__ */ jsxRuntime.jsx(structure.LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsxRuntime.jsx(structure.StructureToolPane, { active, groupIndex, index: paneIndex, pane: pane_4, childItemId, itemId, paneKey, params: paneParams, payload, path, selected, siblingIndex, maximized, onSetMaximizedPane: () => onSetMaximizedPane(paneData_0) }) }, `${pane_4 === structure.LOADING_PANE ? "loading" : pane_4.type}-${paneIndex}`);
    }, $[26] = onSetMaximizedPane, $[27] = t162) : t162 = $[27], t15 = paneItemsToShow.map(t162), $[23] = onSetMaximizedPane, $[24] = paneItemsToShow, $[25] = t15;
  } else
    t15 = $[25];
  let t16;
  $[28] !== isResolvingIntent || $[29] !== paneDataItems.length ? (t16 = paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */ jsxRuntime.jsx(structure.LoadingPane, { paneKey: "intent-resolver" }), $[28] = isResolvingIntent, $[29] = paneDataItems.length, $[30] = t16) : t16 = $[30];
  let t17;
  $[31] !== handleRootCollapse || $[32] !== handleRootExpand || $[33] !== media[1] || $[34] !== t13 || $[35] !== t15 || $[36] !== t16 ? (t17 = /* @__PURE__ */ jsxRuntime.jsxs(StyledPaneLayout, { flex: 1, height: t13, minWidth: t14, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t15,
    t16
  ] }), $[31] = handleRootCollapse, $[32] = handleRootExpand, $[33] = media[1], $[34] = t13, $[35] = t15, $[36] = t16, $[37] = t17) : t17 = $[37];
  let t18;
  $[38] !== resolvedPanes ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(StructureTitle, { resolvedPanes }), $[38] = resolvedPanes, $[39] = t18) : t18 = $[39];
  let t19;
  $[40] === Symbol.for("react.memo_cache_sentinel") ? (t19 = /* @__PURE__ */ jsxRuntime.jsx("div", { "data-portal": "", ref: setPortalElement }), $[40] = t19) : t19 = $[40];
  let t20;
  $[41] !== t12 || $[42] !== t17 || $[43] !== t18 ? (t20 = /* @__PURE__ */ jsxRuntime.jsxs(ui.PortalProvider, { element: t12, children: [
    t17,
    t18,
    t19
  ] }), $[41] = t12, $[42] = t17, $[43] = t18, $[44] = t20) : t20 = $[44];
  let t21;
  return $[45] !== resolvedPanesValue || $[46] !== t20 ? (t21 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.ResolvedPanesProvider, { value: resolvedPanesValue, children: t20 }), $[45] = resolvedPanesValue, $[46] = t20, $[47] = t21) : t21 = $[47], t21;
});
