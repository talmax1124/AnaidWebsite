...
`, Button = React.forwardRef(function(t0, ref) {
  ...
  let t4;
  $[8] !== mode || $[9] !== paddingLeft || $[10] !== paddingY || $[11] !== ref || $[12] !== rest || $[13] !== sizeProps || $[14] !== tone ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { ...rest, ...sizeProps, paddingY, paddingLeft, ref, mode, tone }), $[8] = mode, $[9] = paddingLeft, $[10] = paddingY, $[11] = ref, $[12] = rest, $[13] = sizeProps, $[14] = tone, $[15] = t4) : t4 = $[15];
  const children = t4;
  if (tooltipProps) {
    const t5 = tooltipProps?.content;
    let t6;
    $[16] !== children ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TooltipButtonWrapper, { children }), $[16] = children, $[17] = t6) : t6 = $[17];
    let t7;
    return $[18] !== t5 || $[19] !== t6 || $[20] !== tooltipProps ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { content: t5, portal: !0, ...tooltipProps, children: t6 }), $[18] = t5, $[19] = t6, $[20] = tooltipProps, $[21] = t7) : t7 = $[21], t7;
  }
  return children;
