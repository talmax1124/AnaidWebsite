...
const STATUS_DICTIONARY = {
  ...
  minimal: !0,
  useTemporalPhrase: !0
}, MotionButton = react$1.motion.create(ui.Button), MotionBox = react$1.motion.create(ui.Box);
...
const ButtonSkeleton = () => {
  ...
  const t0 = event.author, t1 = sanity.TIMELINE_ITEM_I18N_KEY_MAPPING[event.documentVariantType][event.type];
  let t2;
  $[2] !== t1 ? (t2 = getDocumentStatusKey(t1), $[2] = t1, $[3] = t2) : t2 = $[3];
  let t3;
  return $[4] !== event.author || $[5] !== event.timestamp || $[6] !== t2 ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusButton, { author: t0, translationKey: t2, timestamp: event.timestamp }), $[4] = event.author, $[5] = event.timestamp, $[6] = t2, $[7] = t3) : t3 = $[7], t3;
}, TimelineStatus = () => {
  const $ = reactCompilerRuntime.c(10), {
    timelineStore
  ...
  let t3;
  return $[6] !== author || $[7] !== event.endTimestamp || $[8] !== t2 ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusButton, { author, translationKey: t2, timestamp: event.endTimestamp }), $[6] = author, $[7] = event.endTimestamp, $[8] = t2, $[9] = t3) : t3 = $[9], t3;
