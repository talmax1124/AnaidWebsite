...
const useSharedState = (key, value) => {
  ...
  resources: () => Promise.resolve().then(function() {
    return require("./resources8.js");
  })
});
function usePresentationPerspectiveStack() {
  const $ = reactCompilerRuntime.c(3), {
    perspectiveStack
  } = sanity.usePerspective(), paneRouter = React.useContext(structure.PaneRouterContext);
  if (!paneRouter)
...
function useDocumentLocations(props) {
  const $ = reactCompilerRuntime.c(23), {
    ...
    type,
    version
  } = props, documentStore = sanity.useDocumentStore(), documentPreviewStore = sanity.useDocumentPreviewStore(), perspectiveStack = usePresentationPerspectiveStack(), [locationsState, setLocationsState] = React.useState(INITIAL_STATE), resolver = resolvers && (typeof resolvers == "function" ? resolvers : resolvers[type.name]), [locationsStatus, setLocationsStatus] = React.useState(resolver ? "resolving" : "empty");
  let t0;
  bb0: {
    if (!resolver) {
      t0 = void 0;
...
function LocationItem(props) {
  const $ = reactCompilerRuntime.c(27), {
    ...
    active,
    toolName
  } = props, presentation = React.useContext(_singletons.PresentationContext), currentPresentationToolName = useCurrentPresentationToolName(), isCurrentTool = toolName === currentPresentationToolName, navigate = presentation?.navigate, {
    params: paneParams
  } = structure.usePaneRouter(), t0 = presentation?.structureParams;
  let t1;
  ...
  let t5;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(icons.DesktopIcon, {}) }) }), $[13] = t5) : t5 = $[13];
  let t6;
  $[14] !== node.title ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, weight: "medium", children: node.title }), $[14] = node.title, $[15] = t6) : t6 = $[15];
  let t7;
  $[16] !== node.href ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: !0, size: 1, textOverflow: "ellipsis", children: node.href }), $[16] = node.href, $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== t6 || $[19] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 3, children: [
    t5,
  ...
  let t9;
  return $[21] !== active || $[22] !== node.href || $[23] !== t3 || $[24] !== t4 || $[25] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { ...t3, as: "a", onClick: t4, padding: 3, radius: 1, pressed: active, tone: "inherit", children: t8 }, node.href), $[21] = active, $[22] = node.href, $[23] = t3, $[24] = t4, $[25] = t8, $[26] = t9) : t9 = $[26], t9;
}
...
function PresentationDocumentProvider(props) {
  ...
  const registerEffectEvent = useEffectEvent.useEffectEvent(t3);
  let t4;
  $[7] !== options || $[8] !== registerEffectEvent ? (t4 = () => registerEffectEvent(options), $[7] = options, $[8] = registerEffectEvent, $[9] = t4) : t4 = $[9];
  let t5;
  $[10] !== options ? (t5 = [options], $[10] = options, $[11] = t5) : t5 = $[11], React.useLayoutEffect(t4, t5);
  let t6;
  return $[12] !== children || $[13] !== context ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.PresentationDocumentContext.Provider, { value: context, children }), $[12] = children, $[13] = context, $[14] = t6) : t6 = $[14], t6;
}
function _temp() {
  return [];
}
function useOpenInStructureAction(props) {
  const $ = reactCompilerRuntime.c(13), {
    ...
    navigateIntent
  } = router$1.useRouter(), presentation = React.useContext(_singletons.PresentationContext), t0 = presentation?.name || DEFAULT_TOOL_NAME;
  let t1;
  ...
  const defaultStructureTool = t1, t2 = !presentation || path.length > 0 || !defaultStructureTool, t3 = defaultStructureTool?.icon || icons.MasterDetailIcon, t4 = `Open in ${defaultStructureTool?.title || "Structure"}`;
  let t5;
