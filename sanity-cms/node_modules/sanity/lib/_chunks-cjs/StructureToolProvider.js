...
function StructureToolProvider(t0) {
  const $ = reactCompilerRuntime.c(26), {
    ...
    children
  } = t0, [layoutCollapsed, setLayoutCollapsed] = React.useState(!1), source = sanity.useSource(), configContext = sanity.useConfigContextFromSource(source), documentStore = sanity.useDocumentStore(), {
    perspectiveStack
  ...
  let t9;
  return $[23] !== children || $[24] !== structureTool ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.StructureToolContext.Provider, { value: structureTool, children }), $[23] = children, $[24] = structureTool, $[25] = t9) : t9 = $[25], t9;
}
