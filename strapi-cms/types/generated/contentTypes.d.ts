...
export interface ApiAddOnAddOn extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service add-ons and upgrades';
    displayName: 'Add-on';
    pluralName: 'add-ons';
    singularName: 'add-on';
  };
  ...
  attributes: {
    ...
    applicableServiceTypes: Schema.Attribute.Text;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['product', 'service', 'both']> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skinType: Schema.Attribute.Enumeration<
      ['All Skin Types', 'Dry', 'Oily', 'Combination', 'Sensitive', 'Mature']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Beauty and esthetic services';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    aftercare: Schema.Attribute.Text;
    available: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    beforeAfterImages: Schema.Attribute.Media<'images', true>;
    benefits: Schema.Attribute.Text;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    preparation: Schema.Attribute.Text;
    price: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
